...
public class KeeperGuessFrame extends JFrame {
	...
	public KeeperGuessFrame(final Game game) {
		this.game = game;
		...
		guess.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (w == null || gc == null) {
					int r = JOptionPane
							.showConfirmDialog(
									wPanel,
									new JLabel(
											"You must select 3 items before you can make a guess"),
									"Can't do that !",
				...
				game.getCurrent().executeGuess(w, gc, r);
